...
function RegisterForm({setFirstName, setLastName, setTelephone, setEmail, setSpecialRequest})  {
        return (
            <div className="">
                    ...
                    <div className="row g-3">
                        <div className="col-sm-6">
                            ...
                            <input type="text" className="form-control" id="firstName" placeholder="" value=""
                                   required="" onChange={e => setFirstName(e.target.value)}></input>
                        ...
                        <div className="col-sm-6">
                            ...
                            <input type="text" className="form-control" id="lastName" placeholder="" value=""
                                   required="" onChange={e => setLastName(e.target.value)}></input>
                                <div className="invalid-feedback">
                        ...
                        <div className="col-12">
                            ...
                            <input type="tel" className="form-control" id="phone" name="phone" placeholder="Phone"
                                   required="" pattern="[0-9]{3}-[0-9]{2}-[0-9]{3}" onChange={e => setTelephone(e.target.value)}></input>
                            </div>
                        </div>
